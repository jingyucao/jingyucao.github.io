...
import {mapProps} from "./MapPC";

const MapPhone = (props:mapProps)=>{
    ...
    const OptionsOnPhone = {
        title: {
            text: 'COVID-19 infection rate in Germany in 2022',
    ...
    return (
        <StatesDataMap options={OptionsOnPhone}/>
    )
}
